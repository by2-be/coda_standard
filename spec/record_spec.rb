...
describe CodaStandard::Record do
  ...
  let(:data_movement1b_record) {  CodaStandard::Record.new("21000100000001500000103        10000000005008600104150015000010UNSTRUCTURED COMMUNICATION MESSAGE                                      31031501601 0")}
